...
public class DummyDataTable {
	...
	public static List<SoftwareEngineer> getSoftwareEngineer() {
		SoftwareEngineer[] list = { new SoftwareEngineer("User-1", "User-1", "Durga", 60, false),
				new SoftwareEngineer("User-2", "User-2", "Sunil", 25, true),
				new SoftwareEngineer("User-3", "User-3", "Sayan", 26, true),
				new SoftwareEngineer("User-4", "User-4", "Subbu", 28, false),
				new SoftwareEngineer("User-5", "User-5", "Ravi", 17, true) };
